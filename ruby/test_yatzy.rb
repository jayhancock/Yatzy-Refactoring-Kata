...
class YatzyTest < Test::Unit::TestCase
  ...
  FOUR_DICE = [
    ...
    [:two_pair, [3,5,3,5], 16],
    [:two_pair, [3,3,4,5], 0],
    [:three_of_a_kind, [3,3,3,4], 9],
    [:three_of_a_kind, [3,3,3,3], 9],
    [:three_of_a_kind, [5,3,5,5], 15],
    [:three_of_a_kind, [1,3,5,5], 0],
    [:four_of_a_kind, [3,3,3,3], 12],
    [:four_of_a_kind, [5,5,5,5], 20],
    [:four_of_a_kind, [3,3,3,4], 0],
    [:small_straight, [1,2,3,4], 15],
    [:small_straight, [2,3,4,1], 15],
    [:small_straight, [1,2,3,5], 0],
    [:small_straight, [2,3,4,5], 0],
    [:large_straight, [6,3,4,5], 20],
    [:large_straight, [3,4,5,6], 20],
    [:large_straight, [2,3,4,5], 0],
    [:large_straight, [1,2,2,4], 0],
    [:full_house, [6,2,2,6], 0]
  ]
